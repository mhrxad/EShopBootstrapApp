...
(function ($) {
  ...
  $(".li-countdown")
    .countdown("2019/12/01", function (event) {
      $(this).html(
        event.strftime('<div class="count">%D <span>روز:</span></div> <div class="count">%H <span>ساعت:</span></div> <div class="count">%M <span>دقیقه:</span></div><div class="count"> %S <span>ثانیه</span></div>')
      );
    });
  /*----------------------------------------*/
  /* 09. Tooltip Active
